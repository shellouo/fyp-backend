...
onMounted(() => {
  ...
  function initFramebuffers() {
    ...
    // 类型断言解决unknown问题
    type GLFormat = { internalFormat: number; format: number };
    const texType = ext.halfFloatTexType;
    const rgba = ext.formatRGBA as GLFormat;
    const rg = ext.formatRG as GLFormat;
    const r = ext.formatR as GLFormat;
